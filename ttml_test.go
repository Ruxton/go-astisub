...
func TestTTML(t *testing.T) {
	...
	assert.Equal(t, []astisub.Line{{{Style: s.Styles["style_1"], InlineStyle: &astisub.StyleAttributes{TTMLColor: "black"}, Text: "(deep rumbling)"}}}, s.Items[0].Lines)
	assert.Equal(t, []astisub.Line{{{InlineStyle: &astisub.StyleAttributes{}, Text: "MAN:"}}, {{InlineStyle: &astisub.StyleAttributes{}, Text: "How did we"}, {InlineStyle: &astisub.StyleAttributes{TTMLColor: "green"}, Style: s.Styles["style_1"], Text: "end up"}, {InlineStyle: &astisub.StyleAttributes{}, Text: "here?"}}}, s.Items[1].Lines)
	assert.Equal(t, []astisub.Line{{{InlineStyle: &astisub.StyleAttributes{}, Style: s.Styles["style_1"], Text: "This place is horrible."}}}, s.Items[2].Lines)
	assert.Equal(t, []astisub.Line{{{InlineStyle: &astisub.StyleAttributes{}, Style: s.Styles["style_1"], Text: "Smells like balls."}}}, s.Items[3].Lines)
	assert.Equal(t, []astisub.Line{{{InlineStyle: &astisub.StyleAttributes{}, Style: s.Styles["style_2"], Text: "We don't belong"}}, {{InlineStyle: &astisub.StyleAttributes{}, Style: s.Styles["style_1"], Text: "in this shithole."}}}, s.Items[4].Lines)
	assert.Equal(t, []astisub.Line{{{InlineStyle: &astisub.StyleAttributes{}, Style: s.Styles["style_2"], Text: "(computer playing"}}, {{InlineStyle: &astisub.StyleAttributes{}, Style: s.Styles["style_1"], Text: "electronic melody)"}}}, s.Items[5].Lines)
